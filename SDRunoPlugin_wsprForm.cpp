...
// Form deconstructor
	SDRunoPlugin_wsprForm::~SDRunoPlugin_wsprForm () {
}

// Start Form and start Nana UI processing
void	SDRunoPlugin_wsprForm::Run()
{
	show();
	nana::exec();
}
...
void	SDRunoPlugin_wsprForm::Setup() {
	...
	hModule = GetModuleHandle(L"SDRunoPlugin_wspr");
	hdc = GetDC(NULL);
	...
	*(BITMAPINFO*)(settoverPixels + sizeof(BITMAPFILEHEADER)) = bmInfo_sett_over;
	...
	title_bar_label.caption("< bold size = 6 color = 0x000000 font = \"Verdana\">wspr decoder</>");
	...
	bandSelector.push_back ("LF");
	bandSelector.push_back ("MF");
	bandSelector.push_back ("160m");
	bandSelector.push_back ("80m");
	bandSelector.push_back ("60m");
	bandSelector.push_back ("40m");
	bandSelector.push_back ("30m");
	bandSelector.push_back ("20m");
	bandSelector.push_back ("17m");
	bandSelector.push_back ("15m");
	bandSelector.push_back ("12m");
	bandSelector.push_back ("10m");
	bandSelector.push_back ("6m");
	bandSelector.push_back ("4m");
	bandSelector.push_back ("2m");
	bandSelector.push_back ("1m25");
